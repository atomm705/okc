...
!function (e, t, a, n) {
    ...
    s.Defaults = {
        ...
        this.$element.find("." + this.options.classes.event).each(function () {
            var a = e(this), n = new Date(a.data("date")).valueOf();
        ...
        var t = this, a = this.options, s = this.$element.find("." + a.classes.table),
        ...
        r.append(d);
        var l = this.$element.data("currentDate"), i = new Date(l.getFullYear(), l.getMonth() + 1, 0).getDate(),
            c = new Date(l.getFullYear(), l.getMonth(), 0).getDate(),
            h = new Date(l.getFullYear(), l.getMonth(), 1).getDay(), u = 1,
            p = !0 === this.$element.data("first-day-monday") ? 2 : 1;
        for (o = 0; 7 > o; o++) {
            d = e('<div  class="rdc-table-row" />');
            for (var v = 0; 7 > v; v++) {
                var y = 7 * o + v + p, f = e('<div class="' + t.options.classes.table_date + '-outer"/>'), g = n, _ = n,
                    m = e("<div/>", {class: a.classes.table_date}), b = new Date;
                if (b.setHours(0), b.setMinutes(0), b.setSeconds(0), b.setMilliseconds(0), 0 == v && y > i + h) break;
                1 > y - h ? (m.text(c + (y - h)).addClass(a.classes.table_prev), y = new Date(l.getFullYear(), l.getMonth() - 1, c + (y - h))) : y <= i + h ? (m.text(y - h), y = new Date(l.getFullYear(), l.getMonth(), y - h)) : (m.text(u).addClass(a.classes.table_next), y = new Date(l.getFullYear(), l.getMonth() + 1, u++)), y.valueOf() == b.valueOf() && m.addClass(a.classes.table_today), y.valueOf() in this.evt && (f.addClass(a.classes.table_has_events), g = e("<div/>", {class: a.classes.table_events_count}).text(this.evt[y.valueOf()].length), _ = e("<ul/>", {class: a.classes.table_events}), e(this.evt[y.valueOf()]).each(function () {
...
!function (o) {
    o.fn.UItoTop = function (n) {
        ...
        o(i).on('click touchstart', function (e) {
            e.preventDefault();
            o("html, body").stop(true, true).animate({scrollTop: 0}, t.scrollSpeed, t.easingType);
            return false;
        });
        ...
        o(window).scroll(function () {
            ...
            n > t.min ? o(i).stop(true, true).addClass("active") : o(i).removeClass("active");
        });
    }
}(jQuery);
