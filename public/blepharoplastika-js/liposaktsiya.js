...
/*function Resizer(node, divisor) {
    ...
    self.resize = function (ev) {
        ...
        document.addEventListener('mouseup', function () {
            document.removeEventListener('mousemove', _s.move);
        }, { once: true });
    };
    ...
    self.resizeTouch = function (evt) {
        ...
        _s.moveTouch = function (ev) {
            var moveX = (ev.changedTouches[0].pageX - _s.startTouchX);
            moveX *= -1;
        ...
        document.addEventListener('touchend', function () {
            document.removeEventListener('touchmove', _s.moveTouch);
        }, { once: true });
    };
