                                ...
                                <div class="row">
                                    <div class="col-lg-7 section-slider-custom">
                                        <div class="inset-xl-right-80 text-lg-start">
                                            ...
                                            <h5 class="d-none d-lg-block mw-400">@lang('messages.At Medina, we are dedicated to diagnosing all kinds of diseases.')</h5><a class="btn btn-ellipse btn-white offset-top-24" href="">@lang('messages.make an appointment')</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 section-slider-custom to-front">
                                        <div class="text-lg-start">
                                            ...
                                            <h5 class="d-none d-lg-block mw-400">@lang('messages.Since our foundation, we`ve been delivering diagnostic solutions').</h5><a class="btn btn-ellipse btn-white offset-top-24" href="">@lang('messages.make an appointment')</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-7 section-slider-custom">
                                        <div class="text-lg-start">
                                            ...
                                            <h5 class="d-none d-lg-block mw-400">@lang('messages.Our team of diagnosticians is always ready to help you be healthier.')</h5><a class="btn btn-ellipse btn-white offset-top-24" href="">@lang('messages.make an appointment')</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
