<x-app-layout>
    ...
    <!--<section class="section-lg section bg-default">
        <div class="container">
            <h3 class="text-center">Відео-відгуки</h3>
            <div class="offset-top-66">
                <div class="owl-carousel-middle">

                    <div
                        class="owl-carousel owl-2 owl-carousel-default owl-carousel-class-light owl-carousel-middle owl-loaded"
                        data-loop="false" data-items="1" data-sm-items="2" data-dots="true" data-mouse-drag="false"
                        data-lg-items="5"
                        data-owl="{&quot;dots&quot;:true,&quot;nav&quot;:false,&quot;autoplayTimeout&quot;:3500}"
                        style="">
                        ...
                        <div class="owl-stage-outer">
                            <div class="owl-stage"
                                 style="transform: translate3d(-482px, 0px, 0px); transition: 0.25s; width: 3618px;">
                                <div class="owl-item " style="width: 211.2px; margin-right: 30px;"><a class="text-center"
                                                                                                     href="https://youtu.be/EJGBeL5vNng"><img
                                            src="https://i.ytimg.com/vi/EJGBeL5vNng/hqdefault.jpg" alt="" width="365"
                                            height="274">
                                    </a></div>
                                <div class="owl-item" style="width: 211.2px; margin-right: 30px;"><a
                                        href="https://youtu.be/tCqJfCOzP3E"><img class="d-inline-block "
                                                                                 src="https://i.ytimg.com/vi/tCqJfCOzP3E/hqdefault.jpg"
                                                                                 alt="" width="365" height="274">
                                    </a></div>
                                <div class="owl-item active" style="width: 211.2px; margin-right: 30px;"><a
                                        class="text-center" href="https://youtu.be/FuRRxFJXjMA"><img
                                            class="d-inline-block "
                                            src="https://i.ytimg.com/vi/FuRRxFJXjMA/hqdefault.jpg" alt="" width="365"
                                            height="274">
                                    </a></div>
                                <div class="owl-item active" style="width: 211.2px; margin-right: 30px;"><a
                                        class="text-center" href="https://youtu.be/r9p-qcjo4c8"><img
                                            class="d-inline-block "
                                            src="https://i.ytimg.com/vi/r9p-qcjo4c8/hqdefault.jpg" alt="" width="365"
                                            height="274"></a></div>
                                <div class="owl-item active" style="width: 211.2px; margin-right: 30px;"><a
                                        class="text-center" href="https://youtu.be/vM-KZv-sFls"><img
                                            class="d-inline-block "
                                            src="https://i.ytimg.com/vi/vM-KZv-sFls/hqdefault.jpg" alt="" width="365"
                                            height="274"></a></div>
                                <div class="owl-item active" style="width: 211.2px; margin-right: 30px;"><a
                                        class="text-center" href="https://youtu.be/L6KlYL27kNo"><img
                                            class="d-inline-block "
                                            src="https://i.ytimg.com/vi/L6KlYL27kNo/hqdefault.jpg" alt="" width="365"
                                            height="274"></a></div>
                                <div class="owl-item active" style="width: 211.2px; margin-right: 30px;"><a
                                        class="text-center" href="https://youtu.be/BFTGttBfehA"><img
                                            class="d-inline-block "
                                            src="https://i.ytimg.com/vi/BFTGttBfehA/hqdefault.jpg" alt="" width="365"
                                            height="274"></a></div>
                                <div class="owl-item" style="width: 211.2px; margin-right: 30px;"><a class="text-center"
                                                                                                     href="https://youtu.be/J7RxOhMSFKo"><img
                                            class="d-inline-block "
                                            src="https://i.ytimg.com/vi/J7RxOhMSFKo/hqdefault.jpg" alt="" width="365"
                                            height="274"></a></div>
                                <div class="owl-item" style="width: 211.2px; margin-right: 30px;"><a class="text-center"
                                                                                                     href="https://youtu.be/exE6RxpcXsA"><img
                                            class="d-inline-block "
                                            src="https://i.ytimg.com/vi/exE6RxpcXsA/hqdefault.jpg" alt="" width="365"
                                            height="274"></a></div>
                                <div class="owl-item" style="width: 211.2px; margin-right: 30px;"><a class="text-center"
                                                                                                     href="https://youtu.be/HYKcQcdxDxw"><img
                                            class="d-inline-block "
                                            src="https://i.ytimg.com/vi/HYKcQcdxDxw/hqdefault.jpg" alt="" width="365"
                                            height="274">
                                    </a></div>
                                <div class="owl-item" style="width: 211.2px; margin-right: 30px;"><a class="text-center"
                                                                                                     href="https://youtu.be/_6iFnaOe03k"><img
                                            class="d-inline-block "
                                            src=" https://i.ytimg.com/vi/_6iFnaOe03k/hqdefault.jpg" alt="" width="365"
                                            height="274">
                                    </a></div>
                                <div class="owl-item" style="width: 211.2px; margin-right: 30px;"><a class="text-center"
                                                                                                     href="https://youtu.be/GuBJvElbDyg"><img
                                            class="d-inline-block "
                                            src=" https://i.ytimg.com/vi/GuBJvElbDyg/hqdefault.jpg" alt="" width="365"
                                            height="274">
                                    </a></div>
                                <div class="owl-item" style="width: 211.2px; margin-right: 30px;"><a class="text-center"
                                                                                                     href="https://youtu.be/fVUt3viHT-8"><img
                                            class="d-inline-block "
                                            src="https://i.ytimg.com/vi/fVUt3viHT-8/hqdefault.jpg" alt="" width="365"
                                            height="274">
                                    </a></div>
                                <div class="owl-item" style="width: 211.2px; margin-right: 30px;"><a class="text-center"
                                                                                                     href="https://youtu.be/yPYtDKQjmdQ"><img
                                            class="d-inline-block "
                                            src="https://i.ytimg.com/vi/yPYtDKQjmdQ/hqdefault.jpg" alt="" width="365"
                                            height="274">
                                    </a></div>
                                <div class="owl-item" style="width: 211.2px; margin-right: 30px;"><a class="text-center"
                                                                                                     href=" https://youtu.be/FhKQ9ZPc6Ys"><img
                                            class="d-inline-block "
                                            src=" https://i.ytimg.com/vi/FhKQ9ZPc6Ys/hqdefault.jpg" alt="" width="365"
                                            height="274">
                                    </a></div>
                            </div>
                        </div>
...
<!--<section class="section-lg section bg-default">
    <div class="container">
        <h3 class="text-center">3 column testimonials</h3>
        <div class="row row-30">
            <div class="col-lg-4">
                <blockquote class="quote quote-classic quote-classic-top">
                    <div class="quote-body">
                        <p class="h4 font-italic text-gray-dark">
                        ...
                        <div class="quote-meta unit flex-row unit-spacing-sm align-items-center">
                            <div class="unit-left unit-item-narrow"><img class="rounded-circle quote-img" width="60" height="60" src=" {{ asset('images/users/user-betty-wade-60x60.jp') }} " alt=""/></div>
                            <div class="unit-body unit-item-wide">
                                <h5 class="quote-author text-capitalize font-weight-bold text-primary">
            ...
            <div class="col-lg-4">
                <blockquote class="quote quote-classic quote-classic-top">
                    <div class="quote-body">
                        <p class="h4 font-italic text-gray-dark">
                            <q>Nunc dignissim tortor augue, et semper quam aliquet et. Donec ornare molestie elit eget imperdiet. Mauris vel felis ac neque egestas condimentum at consectetur turpis.</q>
                        </p>
                        <div class="quote-meta unit flex-row unit-spacing-sm align-items-center">
                            <div class="unit-left unit-item-narrow"><img class="rounded-circle quote-img" width="60" height="60" src="{{ asset('images/users/user-betty-wade-60x60.jpg') }}" alt=""/></div>
                            <div class="unit-body unit-item-wide">
                                <h5 class="quote-author text-capitalize font-weight-bold text-primary">
                                    <cite class="text-normal">Brittany Douglas</cite>
                                </h5>
                                <p class="quote-desc text-capitalize text-gray font-italic">Patient</p>
                            </div>
                        </div>
