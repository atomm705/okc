<x-app-layout>
    <section class="breadcrumbs-custom bg-image context-dark breadcrumbs-creative" style="background-image: url({{ asset('images/bg-6.webp') }});" data-preset='{"title":"Breadcrumbs","category":"header","reload":false,"id":"breadcrumbs"}'>
        <div class="container">
