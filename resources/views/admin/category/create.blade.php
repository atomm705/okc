                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <select name="division_id" class="form-control">
                                            @foreach($divisions as $division)
                                                <option value="{{ $division->id }}">{{ $division->translation->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group mb-2">
                                                ...
                                                <div class="tab-pane fade @if($lang == 'uk') show active @endif" id="navs-top-{{ $lang }}" role="tabpanel">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="short_name_{{ $lang }}" placeholder="" aria-describedby="defaultFormControlHelp" name="short_name_{{ $lang }}"/>
                                                        </div>
                                                        <div class="col-md-12 mb-3">
