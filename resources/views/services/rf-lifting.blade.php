<x-app-layout>
    <main class="body-main">
        ...
        <div class="section-main section-main_m-n section-main_video">
            <div class="page-content">
                <iframe width="100%" height="617" src="https://www.youtube.com/embed/xASkjddRIK0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
