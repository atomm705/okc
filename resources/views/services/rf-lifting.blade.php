<x-app-layout>
    <main class="body-main">
        ...
        <div class="section-main section-main_m-n section-main_video padding--phone">
            <div class="page-content">
                <iframe class="height--phone" width="100%" height="617" src="https://www.youtube.com/embed/xASkjddRIK0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
                    ...
                    <div class="equipment-card">
                        <div class="equipment-card-img">
                            <div class="specialist-card-box">
                                ...
                                <div class="specialist-info">
                                    <a style="text-decoration: underline; color: #0d47a1;" href="/{{ app()->getLocale() }}/doctors/salenkova-olena-anatoliivna">@lang('frontend/rf.specialist_1.description.link')</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="equipment-card-block">
                            <div class="specialist-card-box">
                                ...
                                <div class="specialist-info">
                                    <a style="text-decoration: underline; color: #0d47a1;" href="/{{ app()->getLocale() }}/doctors/khorunzha-lyubov-sergiivna">@lang('frontend/rf.specialist_2.description.link')</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="recall-result-box" id="resultRecall_2">
                                    <div class="recall-result-box__before">
                                        <div class="recall-result-box-img">
                                            <img src="/assets/images/services/co2/slide_2_before.jpg"
                                                 alt="result">
                                        </div>
                                    ...
                                    <div class="recall-result-box__after divisorAfter">
                                        <div class="recall-result-box-img">
                                            <img src="/assets/images/services/co2/slide_2_after.jpg"
                                                 alt="result">
                                        </div>
                        ...
                        <div class="review-box">
                            ...
                            <div class="recall-result">
                                ...
                                <div class="recall-result-box" id="resultRecall_1">
                                    <div class="recall-result-box__before">
                                        <div class="recall-result-box-img">
                                            <img src="/assets/images/services/co2/slide_1_before.jpg"
                                                 alt="result">
                                        </div>
                                    ...
                                    <div class="recall-result-box__after divisorAfter">
                                        <div class="recall-result-box-img">
                                            <img src="/assets/images/services/co2/slide_1_after.jpg"
                                                 alt="result">
                                        </div>
