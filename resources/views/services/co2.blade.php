        ...
        <div class="section-main when-needed after-video-padding">
            <div class="page-content">
                ...
                <div class="advantage">
                    ...
                    <div class="attention-main" style="margin-top: 25px;">
                    ...
                    <div class="equipment-card">
                        <div class="equipment-card-img">
                            <div class="specialist-card-box">
                                ...
                                <div class="specialist-info">
                                    <a style="text-decoration: underline; color: #0d47a1;" href="/{{ app()->getLocale() }}/doctors/salenkova-olena-anatoliivna">@lang('frontend/co2.specialist_1.description.link')</a>
                                </div>
                            </div>
                        ...
                        <div class="equipment-card-block">
                            <div class="specialist-card-box">
                                ...
                                <div class="specialist-info">
                                    <a style="text-decoration: underline; color: #0d47a1;" href="/{{ app()->getLocale() }}/doctors/khorunzha-lyubov-sergiivna">@lang('frontend/co2.specialist_2.description.link')</a>
                                </div>
                            </div>
                        </div>
                    </div>
