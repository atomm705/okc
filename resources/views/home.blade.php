                            ...
                            <div class="rd-navbar-main-element">
                                ...
                                <div class="rd-navbar-search">
                                    ...
                                    <form class="rd-search" action="search-results.html" data-search-live="rd-search-results-live" method="GET">
                                        <div class="form-wrap">
                                            <label class="form-label" >Type and hit enter...</label>
                                            <input class="rd-navbar-search-form-input form-input"  type="text" name="s" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-lg-7 section-slider-custom">
                                        <div class="inset-xl-right-80 text-lg-start">
                                            ...
                                            <h5 class="d-none d-lg-block mw-400">At Medina, we are dedicated to diagnosing all kinds of diseases.</h5><a class="btn btn-ellipse btn-white offset-top-24" href="make-an-appointment.html">make an appointment</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
