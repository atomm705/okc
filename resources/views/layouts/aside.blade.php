    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item active open">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item ">
                    <a href="{{ route('admin.admin-doctors') }}" class="menu-link"   >
                        <div>Доктори</div>
                ...
                <li class="menu-item ">
                    <a href="{{ route('admin.admin-services') }}" class="menu-link" >
                        <div>Сервіси</div>
                    </a>
                </li>
        ...
        <li class="menu-item ">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item ">
                    <a href="{{ route('admin.index') }}" class="menu-link"  >
                        <div>Ультразвукова диагностика</div>
        ...
        <!--<li class="menu-item ">
            <a href="https://demos.themeselection.com/sneat-bootstrap-html-laravel-admin-template/demo-1/app/email" class="menu-link"  target="_blank" >
                ...
                <div>Email</div>
                <div class="badge rounded-pill bg-label-primary fs-tiny text-uppercase ms-auto">Pro</div>
            </a>
